...
fcast_start_date <- ymd("2016-01-15")
#fcaststartdate <- ymd("2016-01-15")
fcast_end_date <- ymd("2016-01-21")
obs_start_date <- ymd("2016-01-13")
obs_end_date <- ymd("2016-01-16")
q_type <- 6
...
p_table <- p_excd_table_s(df_hefs, fcast_start_date, fcast_end_date, am_fcast, q_type) 
plot_grid(p1a, p_table)

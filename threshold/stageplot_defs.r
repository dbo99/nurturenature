...
p_excd_table_s  <- function(df_hefs, dtrmnstc, fcaststartdate, fcastenddate, fcast_i_pddate, q_type) {
  ...
  df_qntls_tablerows <- create_permax_quants_sumtable_s(df_hefs, fcaststartdate, fcastenddate, "mefp_yr", "feet", q_type)

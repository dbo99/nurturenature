...
{
  pday5 <- plot_s_5daypeakstage_web(df_hefs, dtrmnstc, fcasts[5], 6) + ggtitle("5 Days Out, Morning Forecast\n5-Day Maximum Peak Stage Probabilities")
  pday5
  ggsave("stage_trans_5.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakstage_web(df_hefs, dtrmnstc, fcasts[6], 6) + ggtitle("4 Days Out, Morning Forecast\n5-Day Maximum Peak Stage Probabilities")
  pday5
  ggsave("stage_trans_4.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakstage_web(df_hefs, dtrmnstc, fcasts[7], 6) + ggtitle("3 Days Out, Morning Forecast\n5-Day Maximum Peak Stage Probabilities")
  pday5
  ggsave("stage_trans_3.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakstage_web(df_hefs, dtrmnstc, fcasts[8], 6) + ggtitle("2 Days Out, Morning Forecast\n5-Day Maximum Peak Stage Probabilities")
  pday5
  ggsave("stage_trans_2.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakstage_web(df_hefs, dtrmnstc, fcasts[9], 6) + ggtitle("0-1 Days Out, Morning Forecast\n5-Day Maximum Peak Stage Probabilities")
  pday5
  ggsave("stage_trans_1.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
...
plot_s_5daypeakflow_web<- function(df_hefs, dtrmnstc, am_fcast, q_type) {
  ...
  p1 <- ggplot() + 
    ...
    geom_hline(yintercept = .184, linetype = "dashed", color = "gray", show.legend = F, size = 1.5) + 
    geom_line(data = dtrmnstc, aes( x = fcast_t_pst, y = kcfs,color =  "Forecast flow\n(deterministic)" ), size  = 1) +
    geom_label(data = filter(lowflow_levs, unit == "kcfs"), aes(x = midpoint, y = .184, label = "action stage (184 cfs)"), show.legend = F, alpha = 0.6) +
...
{
  pday5 <- plot_s_5daypeakflow_web(df_hefs, dtrmnstc, fcasts[5], 6) + ggtitle("5 Days Out, Morning Forecast\n5-Day Maximum Peak Flow Probabilities")
  pday5
  ggsave("flow_trans_5.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakflow_web(df_hefs, dtrmnstc, fcasts[6], 6) + ggtitle("4 Days Out, Morning Forecast\n5-Day Maximum Peak Flow Probabilities")
  pday5
  ggsave("flow_trans_4.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakflow_web(df_hefs, dtrmnstc, fcasts[7], 6) + ggtitle("3 Days Out, Morning Forecast\n5-Day Maximum Peak Flow Probabilities")
  pday5
  ggsave("flow_trans_3.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakflow_web(df_hefs, dtrmnstc, fcasts[8], 6) + ggtitle("2 Days Out, Morning Forecast\n5-Day Maximum Peak Flow Probabilities")
  pday5
  ggsave("flow_trans_2.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
  
  pday5 <- plot_s_5daypeakflow_web(df_hefs, dtrmnstc, fcasts[9], 6) + ggtitle("0-1 Days Out, Morning Forecast\n5-Day Maximum Peak Flow Probabilities")
  pday5
  ggsave("flow_trans_1.jpg", dpi = 300, width = 7.5, height = 4, units = "in")
